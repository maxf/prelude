...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (csv auto-dim-other-buffers solaire-mode treemacs treemacs-icons-dired treemacs-magit treemacs-projectile dracula-theme selectric-mode xclip elm-mode json-mode company-shell company-tern company-web company indium tide add-node-modules-path js2-refactor rjsx-mode eslint-fix magithub w3m fill-column-indicator flycheck flycheck-elm all-the-icons-ivy all-the-icons-dired all-the-icons neotree csv-mode auto-complete yaml-mode web-mode tern-django ssh-config-mode smartparens smart-newline skewer-mode sass-mode rainbow-delimiters projectile multi-term motion-mode markdown-mode magit helm gitconfig-mode feature-mode exec-path-from-shell ahk-mode ag)))
 '(pixel-scroll-mode t)
